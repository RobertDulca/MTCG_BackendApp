...
public class BattleRepositoryTest {
    ...
    private static BattleRepository gameRepo;

    @BeforeAll
    static void initGameRepo() {
        CardRepository cardRepo = new CardRepository();
        gameRepo = new BattleRepository(cardRepo);
    }
    ...
    void monVSmon(String card1Name, String card2Name, float card1Dmg, float card2Dmg) throws Exception {
        ...
        assertEquals(BattleRepository.BattleOutcome.PLAYER1_WIN, battleOutcome);
    }
    ...
    void specialFight(String card1Name, String card2Name, float card1Dmg, float card2Dmg) throws Exception {
        ...
        assertEquals(BattleRepository.BattleOutcome.PLAYER2_WIN , battleOutcome);
    }
    ...
    void drawFight() throws Exception {
        ...
        assertEquals(BattleRepository.BattleOutcome.DRAW , battleOutcome);
    }
    ...
    private static Stream<Arguments> provideSpecial() {
        return Stream.of(
                ...
                Arguments.of("Ork", "Wizard", 1000.0f, 5.0f),
