...
public class PackagesControllerTest {
    ...
    static void initPackagesController() throws Exception {
        PackagesRepository packageRepository = mock(PackagesRepository.class);
    ...
    void validCreatePackage() throws Exception {
        ...
        assertEquals(HttpStatus.CREATED, ((Response) response).getHttpStatus());
    }
    ...
    void notAdmin() throws Exception {
        ...
        assertEquals(HttpStatus.FORBIDDEN, ((Response) response).getHttpStatus());
    ...
    void tokenMissing() throws Exception {
        ...
        assertEquals(HttpStatus.UNAUTHORIZED, ((Response) response).getHttpStatus());
